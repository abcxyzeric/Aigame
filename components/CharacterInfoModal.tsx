                        ...
                        {character.skills.map((skill, index) => (
                             <li key={index} className="bg-slate-900/30 p-2 rounded-md group">
                                <div className="flex justify-between items-start">
                                    ...
                                    <button onClick={() => onDeleteEntity({ name: skill.name })} className="p-1 text-slate-400 hover:text-red-400 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
